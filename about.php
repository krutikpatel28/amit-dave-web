...
<html lang="en">
<head>
<title>Dr. Amit Dave - About</title>
<meta charset="utf-8">
	...
	<header class="header trans_400">
		<div class="header_content d-flex flex-row align-items-center jusity-content-start trans_400">
			...
			<div class="header_extra d-flex flex-row align-items-center justify-content-end ml-auto">
				...
				<!-- Work Hourse -->
				<div class="work_hours">Mon - Sat: 10:30am - 1pm  & 6pm - 8:30pm</div>

				<!-- Header Phone -->
				<div class="header_phone"><a href="tel:+91 9833 037 208">+91 9833 037 208</a></div>
